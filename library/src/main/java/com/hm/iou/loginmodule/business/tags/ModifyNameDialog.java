 ...
 */
public class ModifyNameDialog extends Dialog implements DialogInterface.OnShowListener {
    ...
    public ModifyNameDialog(@NonNull final Context context) {
        super(context, R.style.UikitAlertDialogStyle_FromBottom);
        setContentView(R.layout.loginmodule_dialog_modify_name);
